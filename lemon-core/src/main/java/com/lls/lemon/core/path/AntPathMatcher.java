package com.lls.lemon.core.path;

import com.lls.lemon.core.exception.LemonArgumentException;
import com.lls.lemon.core.util.StringUtils;
...
/************************************
 * source code come from spring framework core util
...
public class AntPathMatcher implements PathMatcher {
  ...
  public AntPathMatcher(String pathSeparator) {
    if (pathSeparator == null || pathSeparator.trim().isEmpty()) {
      throw new LemonArgumentException("'pathSeparator' is required");
    }
